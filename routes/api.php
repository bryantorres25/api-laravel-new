...
Route::prefix('form-respuestas-usuario')->group(function () {
    ...
    Route::put('/updateInterpretacion', [SRespuestasUsuarioController::class, 'updateInterpretacion']);
    ...
    Route::get('/group', [SRespuestasUsuarioController::class, 'group']);
    Route::get('/print/{id}', [SRespuestasUsuarioController::class, 'print']);
    Route::post('/saveChart', [SRespuestasUsuarioController::class, 'saveChart']);
});

Route::prefix('dashboard-count')->group(function () {
    Route::get('/', [DashboardCountController::class, 'index']);
